...
set cpo&vim
inoremap <S-Tab> 
nnoremap  :call SelectaIdentifier()
...
nnoremap  gf :call SelectaFile("features")
nnoremap  gs :call SelectaFile("public/stylesheets")
nnoremap  gp :call SelectaFile("public")
nnoremap  gl :call SelectaFile("lib")
nnoremap  gh :call SelectaFile("app/helpers")
nnoremap  gm :call SelectaFile("app/models")
nnoremap  gc :call SelectaFile("app/controllers")
nnoremap  gv :call SelectaFile("app/views")
map  n :call RenameFile()
nnoremap  sa :Ag --sass 
nnoremap  sr :Ag --ruby 
nnoremap  sc :Ag --coffee 
nnoremap  f :CtrlP
nnoremap     
nmap SQ :mksession! /Users/Dorian/.vim/sessions/wp-content/session.vim:wqa
...
nnoremap <Down> :echoe "NO! Use j"
nnoremap <Up> :echoe "NO! Use k"
nnoremap <Right> :echoe "NO! Use l"
nnoremap <Left> :echoe "NO! Use h"
vmap <BS> "-d
imap  
...
silent only
cd ~/sites/ts-dev/wp-content
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +543 plugins/sitepress-multilingual-cms/sitepress.class.php
badd +0 ~/sites/ts-dev/redirect.php
badd +1 redirect.php
badd +1 sites/ts-dev/redirect.php
argglobal
silent! argdel *
argadd plugins/sitepress-multilingual-cms/sitepress.class.php
edit plugins/sitepress-multilingual-cms/sitepress.class.php
...
silent! normal! zE
let s:l = 523 - ((2 * winheight(0) + 19) / 38)
...
wincmd w
argglobal
edit ~/sites/ts-dev/redirect.php
onoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
nnoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
onoremap <buffer> <silent> ]] /\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)/:nohls
nnoremap <buffer> <silent> ]] /\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)/:nohls
